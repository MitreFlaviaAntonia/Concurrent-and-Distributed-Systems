        ...
        try {
            ...
            while (!isRetired) {
                ...
                while(!covens[CovenIndex].StopDemons()) {
                    ...
                    grandSorcerersCircle.sleeping.tryAcquire(); //if the demons want to move, first they need permission
                    while(!isAsleep) {
                    ...
                    grandSorcerersCircle.sleeping.release(); //if a demon finished moving it releases the semaphore, another demon may acquire it
                    //or a diagonal are
